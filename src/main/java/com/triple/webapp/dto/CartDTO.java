...
public class CartDTO {
	...
	public String toString() {
		return "CartDTO [cart_no=" + cart_no + ", member_id=" + member_id + ", book_no=" + book_no + ", total_price="
				+ total_price + ", book_title=" + book_title + ", book_contents=" + book_contents + ", book_image="
				+ book_image + ", author=" + author + ", publisher=" + publisher + ", price=" + price + ", pub_date="
				+ pub_date + ", book_hit=" + book_hit + ", category_no=" + category_no + ", book_count=" + book_count
				+ "]";
	}
