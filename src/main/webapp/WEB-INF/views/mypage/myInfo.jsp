				...
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr>
								<th scope="col">ID</th>
								<td>${readMyInfo.member_id}</td>
							</tr>
							<tr>
								<th scope="col">NAME</th>
								<td>${readMyInfo.member_name}</td>
							</tr>
							<tr>
								<th scope="col">EMAIL</th>
								<td>${readMyInfo.member_email}</td>
							</tr>
							<tr>
								<th scope="col">POSTNO</th>
								<td>${readMyInfo.member_postno}</td>
							</tr>
							<tr>
								<th scope="col">ADDRESS</th>
								<td>${readMyInfo.member_address}</td>
							</tr>
							<tr>
								<th scope="col">TEL</th>
								<td>${readMyInfo.member_tel}</td>
							</tr>
							<tr>
								<th scope="col">ROLE</th>
								<td>${readMyInfo.member_role}</td>
							</tr>
							<tr>
								<th scope="col">REGDATE</th>
								<td>${readMyInfo.regdate}</td>
							</tr>
							<tr>
								<th scope="col">UPDATE_DATE</th>
								<td>${readMyInfo.updatedate}</td>
							</tr>
						</thead>
					</table>
					<div class="checkout_btn_inner float-right">
						<a class="btn_1"
							href="<%=application.getContextPath()%>/mypage/update_myInfo/${id}">정보수정하기</a>
						<a class="btn_1"
							href="<%=application.getContextPath()%>/mypage/delete_myInfo/${id}">탈퇴하기</a>
					</div>
				</div>
			</div>
		</div>
