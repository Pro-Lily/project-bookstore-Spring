			...
			<div class="cart_inner">
				<div class="table-responsive">
					<form action="<%=application.getContextPath()%>/mypage/delete" method="post" id="delete_form">
						...
						<b>${id}</b>님 탈퇴를 진행할까요?<br><br>
						PASSWORD : <input type="password" name="member_pwd"><br><br>
						PASSWORD 재입력: <input type="password" name="member_pwd_ck"><br>
						<div class="checkout_btn_inner float-right">
							<input class="btn_1" type="submit" value="탈퇴"> <input
								class="btn_1" type="reset" value="취소">
						</div>
					</form>
				</div>
			</div>
